%% Script to set up the parameters object for the figure 4a experiment (d=2, c=0.5, various p).
...
if isCluster
    parameters.folder = './results/N100-randRing-d2-b1.00-c0.50-dir-k50-cont/[@P1]';
else
