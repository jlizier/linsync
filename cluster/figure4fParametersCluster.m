%% Script to set up the parameters object for the figure 4f experiment (d=4, c=1.0, various p).
...
if isCluster
    parameters.folder = './results/N100-randRing-d4-b1.00-p0.001-dir-k50-cont/[@P1]';
else
