%% Script to set up the parameters object for the figure 4e experiment (d=4, c=1.0, various p).
...
if isCluster
    parameters.folder = './results/N100-randRing-d4-b1.00-c1.00-dir-k50-cont/[@P1]';
else
